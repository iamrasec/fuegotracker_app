  ...
  <div class="container-fluid py-4">
    <div class="row">
      ...
      <div class="col-lg-6 text-right d-flex flex-column justify-content-center">
        <a class="btn bg-gradient-primary mb-0 ms-lg-auto me-lg-0 me-auto mt-lg-0 mt-2" href="<?php echo base_url('/admin/products/add_strain'); ?>">Add Strains</a>
      </div>
    </div>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr class="text-xs font-weight-bold mb-0">
                    <td><?php echo $strain->id; ?></td>
                    <td><?php echo $strain->name; ?></td>
                    <td><?php echo $strain->url; ?></td>
                    <td><a href="<?php echo base_url('admin/products/strains') . "/edit_strain/" .$strain->id; ?>">edit</a></td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
