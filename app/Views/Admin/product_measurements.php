  ...
  <div class="container-fluid py-4">
    <div class="row">
      ...
      <div class="col-lg-6 text-right d-flex flex-column justify-content-center">
        <a class="btn bg-gradient-primary mb-0 ms-lg-auto me-lg-0 me-auto mt-lg-0 mt-2" href="<?php echo base_url('/admin/measurements/add_measurement'); ?>">Add Measurement</a>
      </div>
    </div>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr class="text-xs font-weight-bold mb-0">
                    ...
                    <td><?php echo $measurement->unit; ?></td>
                    <td><a href="<?php echo base_url('admin/products/measurements') . "/edit_measurement/" .$measurement->id; ?>">edit</a></td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
